...
// LICENSE
// NounsComposableItemTokenBaseFactory.sol is a modified version of Foundation's FNDCollectionFactory.sol:
...
contract ComposableItemFactory is IComposableItemFactory, Ownable {
  ...
  function createCollection(
    ...
    IComposableItemInitializer(collectionAddress).initialize(name, symbol, _msgSender(), minter);
