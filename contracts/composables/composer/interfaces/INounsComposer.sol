...
interface INounsComposer {
    ...
    struct ChildTokenState {
        uint256 index;
        uint256 balance;
        uint256 position1; //position is a 1-based index
    }
	...
	event CompositionAdded(uint256 indexed tokenId, address indexed childTokenAddress, uint256 indexed childTokenId, uint256 position1);
	event CompositionRemoved(uint256 indexed tokenId, address indexed childTokenAddress, uint256 indexed childTokenId, uint256 position1);
    ...
    function getComposedChild(uint256 tokenId, uint256 position1) external view returns (ChildToken memory);
